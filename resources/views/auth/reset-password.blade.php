    ...
    <div class="relative min-h-screen flex items-center justify-center p-4 sm:p-6 bg-[#020a18] overflow-hidden">
        ...
        <div class="w-full max-w-md relative animate-in fade-in zoom-in duration-700 py-8" style="z-index: 10;">
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-white tracking-tight drop-shadow-md">Atur Ulang Password</h1>
                <p class="text-cyan-400/80 font-medium mt-2 tracking-wide">Silakan masukkan password baru Anda.</p>
            </div>
            ...
            <div class="glass-card rounded-[2rem] p-8 sm:p-10">
                <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="password" class="block text-sm font-semibold text-slate-300 mb-2 ml-1">Password Baru</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i class="fas fa-lock text-slate-500 group-focus-within:text-cyan-400 transition-colors"></i>
                            </div>
                            <input type="password" id="password" name="password" required autofocus
                                class="block w-full pl-11 pr-4 py-4 bg-slate-950/40 border border-slate-700/50 rounded-2xl text-white font-medium focus:outline-none focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-400 transition-all duration-300"
                                placeholder="••••••••">
                        </div>
                    </div>

                    <div>
                        <label for="password_confirmation" class="block text-sm font-semibold text-slate-300 mb-2 ml-1">Konfirmasi Password</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i class="fas fa-check-double text-slate-500 group-focus-within:text-cyan-400 transition-colors"></i>
                            </div>
