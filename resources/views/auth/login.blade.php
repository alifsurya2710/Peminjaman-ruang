    ...
    <div class="relative min-h-screen flex items-center justify-center p-4 sm:p-6 bg-[#020a18] overflow-hidden">
        ...
        <div class="w-full max-w-md relative animate-in fade-in zoom-in duration-700 py-8" style="z-index: 10;">
            <div class="text-center mb-10">
                ...
                <h1 class="text-3xl font-extrabold text-white tracking-tight drop-shadow-md">Ruang Nekat</h1>
                <p class="text-cyan-400/80 font-medium mt-1 tracking-wide">Sistem Peminjaman Ruangan SMKN 1 Katapang</p>
            </div>
                ...
                <form action="/login" method="POST" class="space-y-6">
                    ...
                    <div x-data="{ show: false }">
                        <div class="flex justify-between items-center mb-2 ml-1">
                            ...
                            <a href="{{ route('password.request') }}" class="text-xs font-semibold text-cyan-400 hover:text-cyan-300 transition-colors">Lupa password?</a>
                        </div>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <input :type="show ? 'text' : 'password'" id="password" name="password" required
                                class="block w-full pl-11 pr-12 py-4 bg-slate-950/40 border border-slate-700/50 rounded-2xl text-white font-medium placeholder-slate-500 focus:outline-none focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-400 transition-all duration-300"
                                placeholder="••••••••">
                            <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-500 hover:text-cyan-400 transition-all duration-200 z-10 focus:outline-none">
            ...
            <!-- Footer Link -->
            <div class="text-center mt-8 space-y-1 relative" style="z-index: 10;">
                <p class="text-slate-500 text-sm font-medium">
                    &copy; {{ date('Y') }} SMKN 1 Katapang. All rights reserved.
                </p>
                <p class="text-slate-500 text-xs font-semibold">
                    Development by <a href="https://www.instagram.com/dream.inalgorithms/" target="_blank" class="text-cyan-400/80 hover:text-cyan-300 transition-colors">Alumni XII-RPL 1 Angkatan 2026</a>
                </p>
            </div>
