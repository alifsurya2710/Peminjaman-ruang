...
@section('content')
    <div class="max-w-4xl">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Edit Data Peminjam</h2>
                <p class="text-slate-500 text-sm">Perbarui informasi peminjaman untuk <span class="text-primary-600 font-bold">{{ $borrower->name }}</span>.</p>
            </div>
        </div>

        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
            <div class="p-8">
                <form action="/borrowers/{{ $borrower->id }}" method="POST" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" class="block w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-slate-700 font-medium placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all @error('name') border-rose-400 ring-rose-400/10 @enderror" id="name" name="name" value="{{ old('name', $borrower->name) }}" required>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" class="block w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-slate-700 font-medium placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all @error('phone') border-rose-400 ring-rose-400/10 @enderror" id="phone" name="phone" value="{{ old('phone', $borrower->phone) }}">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" class="block w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-slate-700 font-medium placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all @error('class_name') border-rose-400 ring-rose-400/10 @enderror" id="class_name" name="class_name" value="{{ old('class_name', $borrower->class_name) }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea class="block w-full px-4 py-3 bg-slate-50/50 border border-slate-200 rounded-2xl text-slate-700 font-medium placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all @error('purpose') border-rose-400 ring-rose-400/10 @enderror" id="purpose" name="purpose" rows="3" required>{{ old('purpose', $borrower->purpose) }}</textarea>
                            ...
                            <div class="p-6 rounded-2xl bg-slate-50 border border-slate-100 space-y-4">
                                ...
                                <div class="space-y-4">
                                    <div class="space-y-1">
                                        ...
                                        <input type="date" class="block w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-700 focus:ring-2 focus:ring-primary-500/20 outline-none" id="borrow_date" name="borrow_date" value="{{ old('borrow_date', $borrower->borrow_date->format('Y-m-d')) }}" required>
                                    </div>
                                    <div class="space-y-1">
                                        <label class="text-[10px] font-bold text-slate-500 ml-1" for="borrow_time">Jam Mulai</label>
                                        <input type="time" class="block w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-700 focus:ring-2 focus:ring-primary-500/20 outline-none" id="borrow_time" name="borrow_time" value="{{ old('borrow_time', $borrower->borrow_time) }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6 rounded-2xl bg-slate-50 border border-slate-100 space-y-4">
                                ...
                                <div class="space-y-4">
                                    <div class="space-y-1">
                                        ...
                                        <input type="date" class="block w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-700 focus:ring-2 focus:ring-primary-500/20 outline-none" id="return_date" name="return_date" value="{{ old('return_date', $borrower->return_date->format('Y-m-d')) }}" required>
                                    </div>
                                    <div class="space-y-1">
                                        <label class="text-[10px] font-bold text-slate-500 ml-1" for="return_time">Jam Selesai</label>
                                        <input type="time" class="block w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-700 focus:ring-2 focus:ring-primary-500/20 outline-none" id="return_time" name="return_time" value="{{ old('return_time', $borrower->return_time) }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
