...
<div class="max-w-2xl mx-auto space-y-8">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-extrabold tracking-tight text-slate-800">Tambah Barang</h1>
            <p class="text-sm font-medium text-slate-500">Masukkan data barang baru</p>
        </div>
    </div>

    <form action="/items" method="POST" class="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm">
        @csrf
        <div class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-1.5 text-xs text-slate-400"><i class="fas fa-info-circle mr-1"></i>Pilih ruangan tempat barang ini biasanya berada, agar mudah difilter.</p>
            </div>
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                       ...
                       placeholder="Misal: Kursi Lipat, Meja Belajar, Tenda">
            </div>

            <div>
                <label for="total_stock" class="block text-sm font-bold text-slate-700 mb-2">Total Stok <span class="text-rose-500">*</span></label>
                <input type="number" name="total_stock" id="total_stock" value="{{ old('total_stock', 0) }}" min="0" required
                       class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-primary-50 focus:border-primary-500 transition-all text-slate-700 bg-slate-50 focus:bg-white font-medium">
            </div>
